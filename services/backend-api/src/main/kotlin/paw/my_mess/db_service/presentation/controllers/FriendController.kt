...
class FriendController {
    ...
    fun sendFriendRequest(@RequestParam(value = "target") target: String, @PathVariable("sender") sender: String)
            :ResponseEntity<Any?>
    {
        ...
        return if(response.successful_operation){
            ...
            return ResponseEntity.status(response.code).body(MyError(response.code, response.error, response.message))
        }
    }

    @RequestMapping(value= ["/refuse-request/{receiver}"], method = [RequestMethod.DELETE])
    fun refuseFriendRequest(@PathVariable("receiver") receiver: String, @RequestParam("sender") sender: String)
            :ResponseEntity<Any?>{
    ...
    fun acceptFriendRequest(@PathVariable("receiver") receiver: String, @RequestParam("sender") sender: String):
            ResponseEntity<Any?>{
    ...
    fun blockFriend(@PathVariable("userId") userId: String, @RequestParam("blockedId") blockedId: String)
            :ResponseEntity<Any?>{
    ...
    fun unblockFriend(@PathVariable("userId") userId: String, @RequestParam("unblockedId") unblockedId: String)
            :ResponseEntity<Any?>{
    ...
    fun removeFriend(@PathVariable("userId") userId: String, @RequestParam("removeId") removeId: String)
            :ResponseEntity<Any?>{
