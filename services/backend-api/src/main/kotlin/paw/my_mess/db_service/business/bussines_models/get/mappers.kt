...
fun List<BusinessFriendRequest>.ToBusinessSentFriendRequestList(uid: String): BusinessSentFriendRequestList{
    val list = this.filter { uid == it.fromId }
            .map { it.toId }
    return BusinessSentFriendRequestList(uid, list)
}
